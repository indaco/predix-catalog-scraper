...
def main():
    ...
    print "    * number of available categories:", services_scraper.categoriesCounter()
    print "    * number of available services:", services_scraper.tilesCounter()

    print "\n## Summary for 'Analytics':"
    print "    * number of available categories:", analytics_scraper.categoriesCounter()
    print "    * number of available services:", analytics_scraper.tilesCounter()
